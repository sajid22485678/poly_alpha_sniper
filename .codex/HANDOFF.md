...
Focused and broader validation are green. Successor28 source qualification is prepared at `D:\pytest_tmp_v4\poly_alpha_prospective_exact_v6_source_freeze_successor28_20260826T1032Z`, tested-tree SHA-256 `fa4fcdbfa01eb42289f33c977e56901983f631ec531b1052a0f0e79c188051f7`, with zero pytest launches. Execute `run_full_suite_once.py` exactly once and preserve its first result without retry. Only a verified PASS may authorize distinct materialization. Calibration, tournament, Phase Two, holdout, Phase Three, v5 mutation, and all live capabilities remain forbidden.
