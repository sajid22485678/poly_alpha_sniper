...
- State: `COMBINED_POST_OOS_FINAL17_RUNTIME_SOURCE_AUTHORIZED`.
...
- Research equivalence: Final10-to-Final17 changed only `persistence.py` and two persistence tests; research/config/economics/tournament semantics remain unchanged.
- Terminal Final16 nonce `73d9261b11b44aa19cef4a2821464770` is included in the immutable failed-predecessor set.
- Next: write a non-overwriting external Final17 authority bound to this bridge artifact, then launch one distinct Phase-Two identity. Final16 may never be relaunched.
