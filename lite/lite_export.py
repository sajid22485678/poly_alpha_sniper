    ...
    return {
        ...
        **payload,
        ...
        "live_readiness_blockers": [
            "verified_forward_baseline_expectancy_is_negative",
            "paired_book_fair_value_requires_new_forward_terminal_sample",
            "maker_fill_evidence_is_observational_only",
        ...
        "strategy_candidate": {
            ...
            "fair_value_source": "fee_adjusted_paired_executable_books_plus_bounded_cex",
            "entry_gate": "positive_fee_net_edge_only",
            "maker_mode": "observational_no_fill_claim",
            "exit_rule": "executable_exit_value_vs_conservative_hold_ev",
